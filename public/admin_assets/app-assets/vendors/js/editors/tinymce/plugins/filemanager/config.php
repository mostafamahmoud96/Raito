...
$upload_dir = '/uploads/pub/sources/'; // path from base_url to upload base dir
$current_path = '../../../../../../../../../uploads/pub/sources/'; // relative path from filemanager folder to upload files folder

$thumbs_path =  '../../../../../../../../../uploads/pub/thumbs/';     

$MaxSizeUpload = 100; //Mb    //relative path from filemanager folder to thumbs folder
