            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="card-form side-form" method="POST" action="{{ route('admin.order.store') }}">
                            @csrf
                            <div class="row">

                                <div class="col-lg-3 col-sm-4 col-xs-12 col-6 mx-4 my-3">
                                    <label for="user" style="font-size:x-large;"><i class="fa fa-user-circle"
                                            aria-hidden="true"></i>
                                        Customer</label>
                                ...
                                <!-- payment method -->
                                <div class="col-lg-3 col-sm-6 col-xs-12 col-6  my-3 paymentMethod">
                                    ...
                                    <table class="table table-bordered table-hover" id="orderTable"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width=12% class="px-1 py-1">Price</th>
                                                <th width=12% class="px-1 py-1">Quantity</th>
                                                <th width=12% class="px-1 py-1">Total</th>
                                            </tr>
                                        </thead>
