...
<div class="col-lg-12 text-right">
    ...
    <a class="btn btn-success btn-min-width mr-1 mb-1" href="{{ route('customer.order.create') }}" role="button">New Order </a>
    <a class="btn btn-success btn-min-width mr-1 mb-1" href="{{ route('customer.orders') }}" role="button">All Order </a>
